#!/usr/bin/env node
/**
 * Script pour retirer une place autorisée directement
...
const placeId = process.argv[2] ? Number(process.argv[2]) : undefined;

if (!placeId || isNaN(placeId) || placeId <= 0) {
    console.error('❌ Place ID invalide');
    console.log('Usage: node remove-place-direct.js <placeId>');
    process.exit(1);
}

console.log(`➖ Retrait de la place ${placeId}...`);
